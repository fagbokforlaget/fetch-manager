...
let y = fm.add("https://dev.dpm.fagbokforlaget.no/streams1/5abb7dfa4da57b0000002810/book.hpub", {}).then((resp) => resp.blob()).then(response => {console.log('Success2:', response)}).catch((e) => console.error(e + " error2"));
var x = fm.cancel(2)
...
fm.add("https://dev.dpm.fagbokforlaget.no/api/publications/5abb85f34da57b0000003ea8", {}).then(response => console.log('Success1:', response)).catch((e) => console.error(e + " kurwa mac"));